...
layui.config({
    ...
    var tableInUser = table.render({
        ...
        ,cols: [[
            ...
            ,{field: 'superAdmin', title: '是否超级管理员', width:135,templet: function(d){
                    let superAdmin = d.superAdmin == 1 ? "是" : "否";
                    return  superAdmin +`<button onclick="User.changeSuperAdmin(${d.userId})" class="layui-btn layui-btn-sm font_bule">设置</button>`;
            }}
...
var User={
    ...
    changeSuperAdmin:function (userId, ) {
        layer.open({
            content: '超级管理员设置',
            btn: ['设置', '撤销', '关闭'],
            // 按钮1 的回调
            btn1: function(index, layero, that){
                $.ajax({
                    type:"POST",
                    url:request("/console/changeSuperAdmin"),
                    data:{
                        userId:userId,
                        superAdmin: 1,
                    },
